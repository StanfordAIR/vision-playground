...
# NOTE: Diwakar's dataset has images at 50x50, but the image needs to be divisible by 4 
# for reduction. To resize all the images in the dataset to 48x48, I used ImageMagick 
# (brew install ImageMagick for homebrew), and in that directory, $ magick mogrify -resize 48x48 *.png
