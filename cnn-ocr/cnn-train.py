...
# used to train the network and save checkpoint models.


# ~ parameters ~

# training_epochs - number of epochs
# TRAIN_BATCH_SIZE - amount of images taken when segmenting training
# TEST_BATCH_SIZE - amount of images taken when segmenting testing
# x - tensor for input data. Second parameter is the number of pixels in each training image (28x28 = 784)
# y - tensor for prediction, generated by cnn_model.CNN(x)
# y_ - tensor for the output neurons. Second parameter is the number of total classes (35 for letters and numbers, only one 0/O)
# display_step, validation_step - how often we want to check on training progress

# Note - don't worry about the slim.losses.softmax_cross_entropy warning
